...
class CustomUser(AbstractUser):
    ...
    image = models.ImageField(upload_to='images/user_images/', null=True, blank=True)
...
class Playground(models.Model):
    ...
    bookings = models.ForeignKey('Booking', null=True, blank=True, on_delete=models.CASCADE, related_name='playground_bookings')
    ...
    is_active = models.BooleanField(default=True)
    image = models.ImageField(upload_to='images/playground_images/', null=True, blank=True)
    created_date = models.DateTimeField(default=timezone.now)
    updated_date = models.DateTimeField(default=timezone.now)
...
class Booking(models.Model):
    ...
    admin_status = models.CharField(max_length=15, choices=(('pending', 'Pending'), ('approved', 'Approved'), ('rejected', 'Rejected')), default='pending')
